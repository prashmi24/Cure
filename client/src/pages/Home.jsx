              ...
              <div>
                <div className="lg:w-[570px]">
                  ...
                  <p className="text__para">
                    ...
                    doctors in your area. Our user-friendly platform connects
                    you with a wide range of healthcare professionals, ensuring
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
              ...
              <div className="py-[30px] px-5">
                ...
                <div className="mt-[30px]">
                  ...
                  <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                    Enter your location and the type of doctor you're looking
                    for. Whether it's a primary care physician, a specialist, or
                    a dentist, we've got you covered.
                  </p>
              ...
              <div className="py-[30px] px-5">
                ...
                <div className="mt-[30px]">
                  ...
                  <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                    Once you've found the right doctor, simply select a
                    convenient time slot from their schedule and book your
                    appointment instantly. No more waiting on hold or playing
                    phone tag.
                  </p>
          ...
          <div className="container">
            <div className="xl:w-[470px] mx-auto">
              ...
              <p className="text-para text-center">
                ...
                profiles to find the perfect match for your healthcare needs,
        ...
        <section>
          <div className="container">
            <div className="xl:w-[470px] mx-auto">
              ...
              <p className="text-para text-center">
                Hear directly from other patients about their experiences with
