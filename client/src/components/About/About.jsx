      ...
      <section className="flex flex-col-reverse lg:flex-row items-center justify-between gap-8 lg:gap-16">
        ...
        <div className="w-full lg:w-1/2 xl:w-[670px] order-2 lg:order-1">
          ...
          <p className="text-para mt-4">
            Cure is a revolutionary online platform dedicated to simplifying the
            process of booking appointments with healthcare professionals. With
            the mission of providing accessible and convenient healthcare
          ...
          <p className="text-para mt-8">
            ...
            you're seeking routine check-ups, specialized treatments, or urgent
            care, finding the right doctor and scheduling appointments shouldn't
            be a hassle. That's where Cure comes in. We believe that everyone
            deserves easy access to quality healthcare. That's why we've
            partnered with a vast network of healthcare providers spanning
            various specialties and locations. From primary care physicians to
            specialists in fields such as cardiology, dermatology, and
            pediatrics, we've got you covered.
          </p>
          {/* Learn More button linking to homepage */}
          <Link to="/">
            <button className="btn mt-8" aria-label="Learn more about Cure">
              Learn More
            </button>
          </Link>
        </div>
